...
const CreateTasks = () => {
  ...
  const [taskData, setTaskData] = useState({
    title: "",
    description: "",
    priority: "medium", // Diubah dari "Low" ke "medium"
    dueDate: null,
    assignedTo: [],
    todoCheckList: [],
    attachments: [], // Diubah dari 'attachment' ke 'attachments'
  });
          ...
          <div className="form-card col-span-3">
            ...
            <div className="grid grid-cols-12 gap-4 mt-2 ">
              ...
              <div className=" col-span-6 md:col-span-4">
                ...
                <input placeholder="Create App UI" className="form-input" value={taskData.dueDate} onChange={({ target }) => handleValueChange("dueDate", target.value)}
                type="date" />
              </div>
              ...
              <div className="col-span-12 md:col-span-3">
                <label className="text-xs font-medium text-slate-600">Assign To</label>
                 ...
                 onChange={(selectedUsers) => handleValueChange("assignedTo", selectedUsers)}
                 />
              </div>
            </div>
